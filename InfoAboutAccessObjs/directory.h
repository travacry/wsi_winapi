/********************************************************
	* File: directory.h
	* Discription: The map special right's obj: Directory
	* Created: 28.03.2013
	* Copyright: (C) 2013 AK
...
enumeration_begin(DirectorySARights)
declare_member(FILE_LIST_DIRECTORY) member_value(0x0001) delimiter
declare_member(FILE_ADD_FILE) member_value(0x0002) delimiter
declare_member(FILE_ADD_SUBDIRECTORY) member_value(0x0004) delimiter
declare_member(FILE_READ_EA) member_value(0x0008) delimiter
declare_member(FILE_WRITE_EA) member_value(0x0010) delimiter
declare_member(FILE_TRAVERSE) member_value(0x0020) delimiter
